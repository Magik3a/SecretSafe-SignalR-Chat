namespace SecretSafe.Controllers
{
    ...
    public class MaximumSecurityController : Controller
    {
        private InMemoryRepository _repository;
        private readonly IChatRoomsService chatRoomsService;
        private IRepository<SecretSafeUser> db;
        public MaximumSecurityController(IChatRoomsService chatRoomsService, IRepository<SecretSafeUser> db)
        {
        ...
        public ActionResult Index(Guid id)
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                ViewBag.SecurityLevelName = "Maximum Security";
